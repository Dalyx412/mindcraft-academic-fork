...
export class VisionInterpreter {
    ...
    /** Lazy-loads native canvas/gl deps; disables vision on failure (e.g. Node 24 ABI mismatch). */
    async init() {
        ...
        try {
            ...
            console.warn(`Vision camera unavailable (${err.message}). Vision disabled for ${this.agent.name}.`);
