...
import { describeSharedTaskState } from '../shared_task_state.js';
...
export const queryList = [
    ...
    {
        name: '!sharedTaskState',
        description: 'Show the internal shared task state for team coordination. Do not repeat raw coordinates to human players.',
        perform: async function () {
            return pad('SHARED_TASK_STATE\n' + describeSharedTaskState());
        }
    },
    {
